...
public class dump_rdf {
	...
	public void process(String [] args) throws Exception {
		...
		if(rmlFound)
		{
			...
			if(cmd.contains(variableArg)){
				arglist.add("-variables");
				arglist.add(cmd.getArg(variableArg).getValue());
			}
	...
	private void dump_rdf_usage() {
		...
		System.err.println();
		System.err.println("Usage for dump rdf:  [options] <source mapping>");
		System.err.println("\tOptions:");
		System.err.println("\t\t-o outfile\t\tOutput file name");
		...
		System.err.println("\t\tThe path to the mapping file");
	}
	public void usage() {
