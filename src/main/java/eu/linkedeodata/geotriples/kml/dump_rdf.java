...
/**
 * Command line utility for dumping a KML file to RDF, using the
 ...
 */
public class dump_rdf extends KMLCommandLineTool {
	...
	public void run(CommandLine cmd, KMLSystemLoader loader) throws IOException {
		if (cmd.numItems() == 1) {
