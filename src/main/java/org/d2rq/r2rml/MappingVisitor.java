...
public interface MappingVisitor {
	...
	void visitComponent(GeometryFunction geometryFunction,
			GeometryParametersTerms.Position position, ConstantIRI datatype);
	void visitComponent(GeometryParametersTerms.ConstantValuedTermMap constantValuedTermMap,
			GeometryParametersTerms.Position position);
	void visitComponent(
			GeometryParametersTerms.ColumnOrTemplateValuedTermMap columnOrTemplateValuedTermMap,
			GeometryParametersTerms.Position position);	
	void visitComponent(GeometryParametersTerms.ColumnValuedTermMap columnValuedTermMap,
			GeometryParametersTerms.Position position);
	void visitComponent(GeometryParametersTerms.TemplateValuedTermMap templateValuedTermMap,
			GeometryParametersTerms.Position position);
	void visitComponent(GeometryParametersTerms geometryParametersTerms,
			GeometryParametersTerms.Position position);
	...
	public class DoNothingImplementation implements MappingVisitor {
		...
		public void visitComponent(GeometryParametersTerms.ConstantValuedTermMap termMap,
				GeometryParametersTerms.Position position) { }
		
		public void visitComponent(ColumnOrTemplateValuedTermMap termMap,
				GeometryParametersTerms.Position position) {}
		
		public void visitComponent(ColumnValuedTermMap termMap,
				GeometryParametersTerms.Position position) {}
		
		public void visitComponent(TemplateValuedTermMap termMap,
				GeometryParametersTerms.Position position) {}
		
		public void visitComponent(
				GeometryParametersTerms geometryParametersTerms,
				GeometryParametersTerms.Position position) {}
		@Override
		public void visitComponent(GeometryFunction geometryFunction,
				org.d2rq.r2rml.GeometryParametersTerms.Position position, ConstantIRI datatype) {
