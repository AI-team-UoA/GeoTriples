...
public class PredicateObjectMap extends MappingComponent {
	...
	//d2.1
	private final Set<PredicateObjectMap> predicateObjectMaps =new HashSet<PredicateObjectMap>();
	...
	public void accept(MappingVisitor visitor) {
		...
		//d2.1
				for (PredicateObjectMap predicateObjMap: predicateObjectMaps) {
					predicateObjMap.accept(visitor);
				}
	}
