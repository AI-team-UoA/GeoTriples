...
public class Mapping extends MappingComponent {
	...
	//d2.1
	private final ComponentCollection<GeometryFunction> gfunctions = new ComponentCollection<GeometryFunction>();
	private final ComponentCollection<GeometryParametersTerms> gparameters = new ComponentCollection<GeometryParametersTerms>();
	/**
	...
	public Mapping(String baseIRI) {
		...
		prefixes.setNsPrefix("rrx", RRX.getURI()); //extended mapping see LEO d2.1
		prefixes.setNsPrefix("rrxf", RRX.getFunctionsURI()); //extended mapping see LEO d2.1
	}
	...
	public MappingComponent getMappingComponent(Resource r, ComponentType type) {
		...
		case JOIN:
			return joins.get(r);
		case FUNCTION:
			return gfunctions.get(r);
		case PARAMETERS:
			return gparameters.get(r);
		default:
			return null;
		}
	}
