 ...
 */
public class GeneralNodeRelationProjecter extends OpMutator {
	private final GeneralConnection connection;
	private Set<ProjectionSpec> projections;
	private BindingMaker bindingMaker;
	
	public GeneralNodeRelationProjecter(GeneralNodeRelation original, Set<ProjectionSpec> projections) {
		super(original.getBaseTabular());
		this.projections = projections;
		this.bindingMaker = original.getBindingMaker();
		this.connection = original.getConnection();
	}

	public GeneralNodeRelation getNodeRelation() {
		return new GeneralNodeRelation(connection, getResult(), bindingMaker);
	}
