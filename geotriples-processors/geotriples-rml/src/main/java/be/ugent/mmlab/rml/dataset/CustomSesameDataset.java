 ...
 * @author dimis
 */
public class CustomSesameDataset extends SesameDataSet  {

	// Logger
	private static Logger log = LoggerFactory.getLogger(SesameDataSet.class);
	 ...
	 * @param inferencing
	 */
	public CustomSesameDataset(boolean inferencing) {
		try {
			if (inferencing) {
	...
	public CustomSesameDataset(String pathToDir, boolean inferencing) {
	...
	public static void main(String[] args) {
		CustomSesameDataset r = new CustomSesameDataset();
